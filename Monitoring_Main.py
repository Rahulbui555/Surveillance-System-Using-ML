...
service_account_key = "live_data_tracker.json"
...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'Rahulbui555@gmail.com' ")
...
# Define cnt as a global variable
cnt = 0

def TakeImages():
    global cnt  # Accessing the global variable cnt within the function
    ...
    if cnt == 0:
        ...
        cnt += 1  # Increment cnt after sending data to Firestore
...
message3 = tk.Label(window, text="Motion Detection System" ,fg="white",bg="#262523" ,width=55 ,height=1,font=('times', 29, ' bold '))
...
trackImg = tk.Button(frame1, text="Start Monitoring", command=TrackImages  ,fg="black"  ,bg="yellow"  ,width=35  ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
